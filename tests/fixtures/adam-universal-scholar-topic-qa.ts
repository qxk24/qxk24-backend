    ...
    turns: [
      {
        ...
        mustMatch: [/registered nurse|nurse provides/i, /skills and tools, a career path/i],
    ...
    turns: [
      {
        ...
        mustMatch: [/electrician/i, /skills and tools, a career path/i],
        mustNotMatch: [...TIER1_FORBIDDEN],
      },
    ],
  },
