...
export const JOURNAL_SECTION_HEADINGS: Record<JournalSectionId, string> = {
  ...
  movement_4_alamtologi:    'Alamtologi Framework',
  movement_5_application:   'Application',
  movement_6_invitation:    'Conclusion — Invitation',
  references:               'References',
};

const MIN_SECTION_CHARS = 80;

/** All eight sections written with substantive content. */
