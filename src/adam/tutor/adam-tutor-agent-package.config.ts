 ...
 * ============================================================
 *
 * Agent PIN packages — 3 school bands × 4 volume tiers (MYR one-time).
 * Each PIN is tied to the agent's band (rendah / menengah / IPT).
 *
 ...
 * - No prorated / difference pricing.
 */
...
/** RM per PIN — band schedule (docs/STRIPE_ADAM_TUTOR_PRICES.md). */
...
export function tutorAgentPackageStripePriceId(
  ...
  const value = ENV[STRIPE_PRICE_ENV_KEY[band][tier]];
