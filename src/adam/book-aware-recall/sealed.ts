...
const SEALED_CHAPTER_ANCHORS: Partial<Record<string, string>> = {
  ...
  'bab-2-faktor-xyz': [
    ...
    '• Soalan "Apa itu ABA?" — rujuk Bab 3 (Asas Bentuk Alam); Bab 2 hanya pointer Pola X 2D/3D.',
  ].join('\n'),
  'bab-3-hukum': [
    ...
    '• "Apa itu ABA?": jawab dari Bab 3 — ABA = Asas Bentuk Alam (BUKAN "Asas Bentuk ALAMTOLOGI").',
    '• Bab 3 = huraian penuh ABA + empat hukum Z; Bab 2 hanya merujuk pola X (2D/3D) — bukan definisi lengkap ABA.',
