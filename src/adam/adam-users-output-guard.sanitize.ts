...
import { stripSimpleFactualEchoOpener, stripSimpleFactualPhilosophyTail } from './adam-simple-factual-voice-guard';
import {
  inlineQuranAyat,
...
export function sanitizeUsersOutputSync(
  ...
  polished = stripSimpleFactualPhilosophyTail(polished, userMessage);
