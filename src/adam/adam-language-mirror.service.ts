...
const MALAY_WORDS =
  /\b(saya|anda|awak|dia|kita|kami|mereka|adalah|dengan|untuk|tidak|tak|boleh|macam|kalau|jika|sebab|kerana|bila|nak|dah|pun|lah|kan|tu|ni|kenapa|siapa|apa|bagaimana|terima kasih|selamat|salam|assalamualaikum|assalammualaikum|assalamualaykum|waalaikumussalam|waalaikumsalam|salamualaikum|yang|bermaksud|maksud|terangkan|huraikan|jelaskan|beritahu|faham|ingat|tahu|nampak|rasa|hati|otak|pelajar|pembelajaran|bismillah|hikmah|walaupun|meskipun|jadi|ada|tiada|sudah|belum|lagi|sangat|amat|sikit|banyak|semua|setiap|dalam|pada|kepada|daripada|antara|seperti|contoh|soalan|jawab|bincang|cerita|mengajar|belajar|allah|quran|hadith|founder|pengasas|tolong|buatkan|buat|bantu|sila|struktur|produk|makanan|niaga|usahawan|perniagaan)\b/gi;
