...
export const ENV = {
  ...
  /** ADAM Stream host — USD recurring (monthly + annual). See docs/STRIPE_ADAM_STREAM_PRICES.md */
  STRIPE_PRICE_ID_STREAM_BUSINESS_STARTER_MONTHLY:  optional('STRIPE_PRICE_ID_STREAM_BUSINESS_STARTER_MONTHLY', ''),
  STRIPE_PRICE_ID_STREAM_BUSINESS_STARTER_ANNUAL:   optional('STRIPE_PRICE_ID_STREAM_BUSINESS_STARTER_ANNUAL', ''),
  STRIPE_PRICE_ID_STREAM_BUSINESS_STANDARD_MONTHLY: optional('STRIPE_PRICE_ID_STREAM_BUSINESS_STANDARD_MONTHLY', ''),
  STRIPE_PRICE_ID_STREAM_BUSINESS_STANDARD_ANNUAL:  optional('STRIPE_PRICE_ID_STREAM_BUSINESS_STANDARD_ANNUAL', ''),
  STRIPE_PRICE_ID_STREAM_BUSINESS_PLUS_MONTHLY:     optional('STRIPE_PRICE_ID_STREAM_BUSINESS_PLUS_MONTHLY', ''),
  STRIPE_PRICE_ID_STREAM_BUSINESS_PLUS_ANNUAL:      optional('STRIPE_PRICE_ID_STREAM_BUSINESS_PLUS_ANNUAL', ''),
