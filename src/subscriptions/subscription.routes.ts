  ...
  return c.json({
    ...
    tiers: consumerPlan ? {
      basic: {
        ...
        annualAmount:  0,
        currency:      'USD',
        description:   `Register free — ${consumerFreeDailyLimit()} messages per day (Malaysia timezone).`,
...
function buildTutorPricingTier(
  ...
  return {
    ...
    description:   'All academic subjects — School ($19) or University ($25) per month.',
    monthlyOnly:   true,
    comingSoon:    !paymentWired,
